...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(1,
           h4(a("Home", href='http://78.47.127.49', target='_blank'))
    ),
    #column(1,
     #      h4(a("versions", href='http://78.47.127.49/shiny/GDSC_versions', target='_blank'))
    #),
    column(1,
    ...
    column(12,
           ...
           h5(a("Step 1 - ", strong("Obtain a file"),  "'alterations_across_samples.tsv' for cell lines", strong("from www.cBioportal.org"), href='http://78.47.127.49:3838/CCLE/Anleitung.pdf', target='_blank')),
           ...
           h5("Alternatively, upload custom groups.txt file", a(" - see example", href='http://78.47.127.49:3838/CCLE/groups.txt', target='_blank')),
  ...
  sidebarLayout(
    sidebarPanel(
           ...
           splitLayout(cellWidths = c("85%", "15%"),
                       fileInput("groupstxt","Upload selfmade groups.txt file"),
                       actionButton('RESET', 'reset', style="color: black;
                       background-color:  white;
                       margin-top: 25px;
                       text-align:center;
