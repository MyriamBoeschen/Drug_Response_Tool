...
server <- function(input, output,session) {
  ...
  output$groupsfiles <- downloadHandler(
    filename = function() {
      if (is.null(file_input())==TRUE) {
        paste("", "groups.txt", sep = "")
      } else if (is.null(file_input())==FALSE && input$amountgenes=="One") {
        paste(input$oncgenes, "_groups.txt", sep = "")
      } else if (is.null(file_input())==FALSE && input$amountgenes=="Two") {
        paste(input$oncgenes, "_", input$secondgene, "_groups.txt", sep = "")
      } else if (is.null(file_input())==FALSE && input$amountgenes=="Three") {
